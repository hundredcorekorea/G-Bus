  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-pulse text-gbus-text-muted">로딩 중...</div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-md text-center">
        ...
        <Card>
          ...
          <p className="text-sm text-gbus-text-muted mb-6">
            관리자가 인게임 정보를 확인한 후 승인해 드립니다.
            <br />
            아래 디스코드 서버에 참여하여 인증을 완료해 주세요.
          </p>

          {profile && (
            <div className="bg-gbus-bg rounded-lg p-3 mb-6 text-left text-sm">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium rounded-lg transition-colors w-full justify-center mb-3"
          >
